...
<form action="" method="post">
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                <label>客户编号</label>
                <input name="" type="text" class="dfinput" value="1000002051"/>
            </li>
            <li>
                <label>客户名称</label>
                <input name="" type="text" class="dfinput" value="桃城二厂"/>
            </li>
            <li><label>业务品种</label>
                <cite>
            ...
            <li>
                <label>合同编号</label>
                <input name="" type="text" class="dfinput" value="2000003703"/>
            </li>
            <li>
                <label>凭证流水号</label>
            ...
            <li><label>主办客户经理 </label>
                <input name="" type="text" class="dfinput"  value="徐徐"/>
            </li>
            <li><label>所属机构</label>
                <input name="" type="text" class="dfinput"  value="公司业务部"/>
            </li>
